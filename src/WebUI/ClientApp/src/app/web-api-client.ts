...
export interface IRealEstateAdClient {
    getRealEstateAdById(id: number | undefined): Observable<RealEstateAdDto>;
    create(command: CreateRealEstateAdCommand): Observable<number>;
    update(id: number, command: UpdateRealEstateAdCommand): Observable<FileResponse>;
}

@Injectable({
    providedIn: 'root'
})
export class RealEstateAdClient implements IRealEstateAdClient {
    ...
    getRealEstateAdById(id: number | undefined): Observable<RealEstateAdDto> {
        let url_ = this.baseUrl + "/api/RealEstateAd?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRealEstateAdById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRealEstateAdById(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<RealEstateAdDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<RealEstateAdDto>;
        }));
    }

    protected processGetRealEstateAdById(response: HttpResponseBase): Observable<RealEstateAdDto> {
        ...
        if (status === 200) {
            ...
            result200 = RealEstateAdDto.fromJS(resultData200);
    ...
    update(id: number, command: UpdateRealEstateAdCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/RealEstateAd/{id}";
...
export class RealEstateAdDto implements IRealEstateAdDto {
    id?: number;
    title?: string;
    description?: string | undefined;

    constructor(data?: IRealEstateAdDto) {
        if (data) {
    ...
    static fromJS(data: any): RealEstateAdDto {
        data = typeof data === 'object' ? data : {};
        let result = new RealEstateAdDto();
        result.init(data);
        return result;
    }
...
export interface IRealEstateAdDto {
    id?: number;
    title?: string;
    description?: string | undefined;
}

export class CreateRealEstateAdCommand implements ICreateRealEstateAdCommand {
    title?: string;
    description?: string | undefined;
    location?: Location;
    propertyType?: PropertyType;

    constructor(data?: ICreateRealEstateAdCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateRealEstateAdCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateRealEstateAdCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateRealEstateAdCommand {
    title?: string;
    description?: string | undefined;
    location?: Location;
    propertyType?: PropertyType;
...
export class Location extends ValueObject implements ILocation {
    latitude?: number;
    longitude?: number;
    street?: string;
    city?: string;
...
export interface ILocation extends IValueObject {
    latitude?: number;
    longitude?: number;
    street?: string;
    city?: string;
...
export class UpdateRealEstateAdCommand implements IUpdateRealEstateAdCommand {
    id?: number;
    publicationStatus?: number;

    constructor(data?: IUpdateRealEstateAdCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.publicationStatus = _data["publicationStatus"];
        }
    }

    static fromJS(data: any): UpdateRealEstateAdCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateRealEstateAdCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateRealEstateAdCommand {
    id?: number;
    publicationStatus?: number;
}
